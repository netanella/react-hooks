...
Call order: run lazy initializers, render (including children), cleanup 
effects, useEffect

Don't forget to colocate state to the child component that needs it.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=03%3A%20Lifting%20state&em=netanella1%40gmail.co).
