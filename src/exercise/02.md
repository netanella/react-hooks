...
useRef - gives you an object that you can mutate without triggering 
re-renders. can be used to get access to a previous state value

upgraded useLocalStorageState hook
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=02%3A%20useEffect%3A%20persistent%20state&em=netanella1%40gmail.co).
