...
Before React 18, each state setter would trigger a component rerender, so if we
set status to "resolved" and then set the data, the data will be missing in the
one render. After React 18, 
