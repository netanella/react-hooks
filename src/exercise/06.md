...
useEffect can only return the cleanup function.
Instead, we can declare the async function in the useEffect body and envoke 
it. Another option is to use `.then()` method.
